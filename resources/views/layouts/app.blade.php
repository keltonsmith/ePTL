...
<head>
    ...
    <link type="text/css" href="{{asset('static/icons/material/css/material-design-iconic-font.min.css')}}" rel="stylesheet">
...
<body class="bg-1">
                        ...
                        @if(Auth::check())
                            ...
                            <li class="dropdown dropdown-hover">
                                ...
                                <div class="dropdown-menu fly-from-right">
                                    ...
                                    @hasrole(['admin', 'applicant', 'applicant__company', 'applicant__individual', 'applicant__govt_agency', 'applicant__glc'])
                                        <li>
                                            <a href="{{route('updateaccount')}}" class="row-table">
									...
									<span class="col-cell pl-15">
                                        ...
                                        <li>
                                            <a href="{{route('changepassword')}}" class="row-table">
									<span class="col-cell cell-icon text-center">
    ...
    <div class="footer pt-20 pb-20">
        <div class="container text-center text-small pt-15 pb-20 mb-20">
            ...
            <div class="text-small text-muted">All rights reserved © 2016-2017 ePTL-LLM</div>
        </div>
    </div>
