    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('') }}" class="logo">
          ...
          <span class="logo-mini" style="margin-top: -1px;">{!! config('backpack.base.logo_mini') !!}</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg" style="margin-left: -15px; margin-top: -2px;">{!! config('backpack.base.logo_lg') !!}</span>
        </a>
