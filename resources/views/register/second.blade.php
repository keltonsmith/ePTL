                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="row row-5">
                                    ...
                                    <div class="column col-sm-5 form-control-select">
                                        {!! Form::select('state',
                                        $states->lists('name'),
                                        old('state'),
                                        ['class' => 'form-control',
                                    ...
                                    <div class="column col-sm-4 form-control-select">
                                        {!! Form::select('city',
                                        [],
                                        '',
                                        ['class' => 'form-control',
...
<script>
    $('#state').on('change', function(){
        var state = $(this).val();
        $.ajax({method: "GET", url: '/register/get-city/' + state})
            .done(function(msg){
                var city = $('#city');
                city.find('option').remove();
                for (item in msg) {
//                   console.log(msg[item]['name']);
                    city.append('<option value="' + msg[item]['name'] + '">' + msg[item]['name'] + '</option>');
                }
            });
