                ...
                <div class="column col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    <div class="panel">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <a href="{{ route('dashboard.application.edit', ['id' => $application->id]) }}"
                                   class="btn btn-success btn-block-responsive pl-20 pr-20 pt-10 pb-10 mt-10 text-uppercase" style="width: 100%">
                                    ReEdit Application Form
                                </a>
