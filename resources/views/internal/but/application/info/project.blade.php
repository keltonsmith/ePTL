            ...
            @foreach($application->documentsApplication as $name => $document)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" data-name="{{$name}}" data-review_letter="{{ $review_letter }}" data-structure="{{ $structure }}"  data-image_location="{{ $image_location }}" data-designs="{{ $designs }}" data-pays="{{$pays}}" data-meeting="{{$meeting}}" data-kkr="{{$kkr}}" data-basic="{{url('documents/'.$application->id)}}" class="documentModal">{{trans('bpo.document')}}</a>
