@extends('internal.management.dashboard.layout')
                        ...
                        <table class="table no-margin">
                            ...
                            @foreach(App\Models\Application::all() as $application)
                                <tr>
                                    ...
                                    <td>
                                        <span class="label @if($application->status == 'Pending'){{'label-warning'}}@elseif($application->status == 'Approved'){{'label-success'}}@elseif($application->status == 'Rejected'){{'label-danger'}}@endif">{{$application->status}}</span>
                                    </td>
                                    <td>
