...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('') }}" class="logo">
            ...
            <span class="logo-lg">Management</span>
        </a>
    ...
    @include('internal.management.dashboard.sidebar')
    ...
    <footer class="main-footer">
        @if (config('backpack.base.show_powered_by'))
            <div class="pull-right hidden-xs">
                {{ trans('base.powered_by') }} <a target="_blank" href="http://laravelbackpack.com">Laravel
                    BackPack</a>
            </div>
        @endif
    </footer>
