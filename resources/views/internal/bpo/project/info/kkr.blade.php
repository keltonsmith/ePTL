<div role="tabpanel" class="tab-pane" id="kkr">
        ...
        <div class="column col-sm-10 col-sm-offset-1">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        @include('partials.multi-files', ['name' => 'document'])
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="form-title row-table text-500">
        ...
        <div class="col-cell pl-10">
            KKR Approval Report(docx format)
        </div>
    </div>
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="col-sm-4 col-sm-offset-4">
                        <a href="{{ route('internal.but.kkrDownloadAsFile', ['project_id' => $project->id]) }}" class="btn btn-primary actionModal">{{trans('general.download')}}</a>
                        {{--                        <a href="{{ route('downloadAsDocFile', ['project' => $project->id]) }}" class="btn btn-primary actionModal">{{trans('general.download')}}</a>--}}
                        {{--                        {!! Form::button(trans('general.download'), ['url' => 'result/downloadAsDocFile', 'method' => 'post', 'class' => 'btn btn-success']) !!}--}}
                    </div>
                </div>
