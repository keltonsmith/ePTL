<div role="tabpanel" class="tab-pane" id="results">
    ...
    <div class="form-title row-table text-500">
        ...
        <div class="col-cell pl-10">
            Internal Meeting Report(docx format)
        </div>
    </div>
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="col-sm-4 col-sm-offset-4">
                        <a href="{{ route('internal.but.downloadAsDocFile', ['project_id' => $project->id]) }}" class="btn btn-primary actionModal">{{trans('general.download')}}</a>
