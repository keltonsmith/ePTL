 ...
 * @property-read \App\Models\Data\Inspection $inspections
...
{
    protected $fillable = [
        'application_id', 'project_title', 'slug', 'num', 'status', 'form',
        'documents'
    ];
    ...
    {
        return $this->hasOne('App\Models\Data\Inspection')->latest();
    }
    ...
    {
        $responsibility_ids = collect(
            (Responsibility::where('name', 'converted_project')
                ->orWhere('name', 'technical_review')
                ->orWhere('name', 'issue_permit')
                ->orWhere('name', 'work_surveilance')
                ->get())
        )->pluck('id');
//            ->orWhere('name', '=', 'converted_project')
//            ->orWhere('name', 'generate_work_lettter')->get()->first();
...
//    public function BPO($query)
//    {
//        $responsibility = Responsibility::whereName('converted_project')
////            ->orWhere('name', '=', 'converted_project')
