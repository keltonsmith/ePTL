...
class Development_Details extends Model
{
    ...
    public function highway_processing_amount($contractorCategoryId)
    {
        $row = HighwayProcessingFee::whereDevelopmentTypeId($this->development_type_id)
            ->whereDevelopmentDetailId($this->id)
            ->whereContractorCategoryId($contractorCategoryId)
            ->first();
