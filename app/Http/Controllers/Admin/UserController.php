    ...
    public function __construct()
    {
        ...
        $this->crud->addFields([
            ...
            [  // Select2
                ...
                'entity' => 'contractorOffice', // the method that defines the relationship in your Model
                'attribute' => 'name', // foreign key attribute that is shown to user
                'model' => "App\Models\Data\Office" // foreign key model
            ],
            [ // select_from_array
                'name' => 'roles',
                'label' => 'Role',
...
//            $item->office_id = $request->input('office_id');
            $item->save();
        }
        else
        {
    ...
    public function searchByName(UserRequest $request)
    {
        echo 1;
        exit;
        if (UserRequest::ajax())
