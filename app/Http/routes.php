...
Route::group([
    ...
    Route::get('/', '\Backpack\Base\app\Http\Controllers\AdminController@dashboard');
...
Route::group(['middleware' => ['web']], function() {
    ...
    Route::group(['as' => 'register.', 'prefix' => 'register'], function () {
        ...
        Route::get('get-city/{state}', ['as' => 'get-city', 'uses' => 'RegisterController@getCity']);
    });
    ...
    Route::get('inspections/{inspection_id}/{file}', 'HomeController@inspection')
        ->where(['id' => '[0-9]+', 'file' => '[a-zA-Z0-9_\-]+\.[A-Za-z]{3}']);
});

Route::group(['middleware' => ['web', 'auth']], function(){
    Route::get('updateaccount', ['as' => 'updateaccount', 'uses' => 'ProfileController@updateAccount']);
    Route::get('resetpassword', ['as' => 'changepassword', 'uses' => 'ProfileController@changePassword']);
    Route::post('changepassword', 'ProfileController@onChangePassword');
    Route::post('updateprofile', 'ProfileController@onUpdateProfile');
    /**
     * Dashboard
     */
    ...
    Route::group(['as' => 'internal.', 'namespace' => 'Internal', 'prefix' => 'internal'], function() {
        ...
        Route::group([
            ...
            Route::group(['as' => 'receipt.', 'prefix' => 'receipt'], function(){
                ...
                Route::post('data', ['as' => 'data', 'uses' => 'ReceiptController@getData']);
        ...
        Route::group([
            ...
            Route::get('project/info/downloadAsDocFile/{project_id}', ['as' => 'downloadAsDocFile', 'uses' => 'BaseController@downloadAsDocFile']);
            Route::get('project/info/kkrDownloadAsFile/{project_id}', ['as' => 'kkrDownloadAsFile', 'uses' => 'BaseController@kkrDownloadAsDocFile']);
    ...
    Route::post('apply/total-amount', 'ApplicationAmountController@searchByProcessingFee');
});
...
Route::post('user-ad/search', 'Admin\UserControllerAd@searchByName');
Route::post('pillar-register', ['as' => 'pillar-register', 'uses' => 'Admin\Ad\ServicesFeeController@pillarRegister']);