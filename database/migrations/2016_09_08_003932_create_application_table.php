...
class CreateApplicationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('applications', function (Blueprint $table) {
            $table->increments('id');
			$table->string('app_id', 250)->nullable();
            ...
            $table->enum('direction', ['Northbound', 'Southbound', 'Eastbound', 'Westbound'])->nullable();
            ...
            $table->foreign('highway_id')->references('id')->on('highways');
