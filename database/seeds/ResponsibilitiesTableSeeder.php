...
class ResponsibilitiesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $responsibilities = [
            ...
            12 => ['application_acceptance', 'generate_work_lettter', 'converted_project'],
            31 => ['technical_review', 'issue_permit', 'work_surveilance'],
            36 => ['approval_review'],
//            3 => ['payment_verification'],
//            4 => ['application_acceptance', 'generate_work_lettter', 'converted_project'],
//            8 => ['technical_review', 'issue_permit', 'work_surveilance'],
//            6 => ['approval_review'],
        ];
